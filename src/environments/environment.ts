...
export const environment = {
  ...
  // loginurl: 'http://ec2-3-12-34-165.us-east-2.compute.amazonaws.com/:5000/api/user/login',
  ...
  driversurl: 'http://ec2-3-139-89-46.us-east-2.compute.amazonaws.com:5000/api/companyApi/driver',
